              ...
              if (retcode == 'OK') {
                ...
                if (reprint && state.printing) {
                  ...
                  state.printing.type === 'invoice'
                    ? dispatch('setPrintingInvoice', state.printing.item)
                    : dispatch('setPrintingOrder', state.printing.item)
                }
...
const printerItemPriceText = (price, qty, total) => {
  ...
  return (
    ' '.repeat(startSpaces) + price + ' '.repeat(afterPriceSpaces) + qty + ' '.repeat(afterQtySpaces) + total + '\n'
  )
}
