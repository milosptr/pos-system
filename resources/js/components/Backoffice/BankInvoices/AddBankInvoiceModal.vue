      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div class="grid grid-cols-1 gap-3">
          ...
          <div>
            ...
            <div class="mt-2">
              <input type="text" v-model.number="invoice.amount" name="amount" id="amount" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
          </div>
          <div>
