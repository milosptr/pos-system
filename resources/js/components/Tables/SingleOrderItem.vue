<template>
  <div
    ...
    :class="[{'ShowDelete' : showDelete}, {'text-red-500': order.refund || order.storno}, {'bg-gray-400': showChangedClass && !still}, {'line-through': (order.refund || order.storno) && !routeInvoice}]"
