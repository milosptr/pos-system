<template>
  <div>
          ...
          <TransitionChild
            ...
            <DialogPanel class="relative flex w-full max-w-xs flex-1 flex-col bg-gray-800">
              <TransitionChild
                ...
                leave-from="opacity-100"
                leave-to="opacity-0">
                <div class="absolute left-0 top-0 -ml-12 pt-2">
                  <button
                    type="button"
                ...
                <nav class="mt-5 space-y-1 px-2">
                  <router-link
                    ...
                    <component
                      :is="item.icon"
                      :class="[
                        currentRoute.includes(item.href) ? 'text-gray-300' : 'text-gray-400 group-hover:text-gray-300',
    ...
    <div class="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col">
      ...
      <div class="flex min-h-0 flex-1 flex-col bg-gray-800">
        ...
        <div class="flex-shrink-0">
          <div class="mb-5 flex-1 space-y-2 px-2">
            <a
              v-for="item in bottomNavigation"
              :key="item.name"
              :href="item.href"
              :target="item.blank ? '_blank' : '_self'"
              class="group flex items-center rounded-md bg-gray-700 px-2 py-2 text-sm font-medium text-gray-300 hover:bg-slate-900 hover:text-white">
              <component
                :is="item.icon"
                class="mr-3 h-6 w-6 flex-shrink-0 text-gray-300 group-hover:text-gray-300"
                aria-hidden="true" />
              {{ item.name }}
            </a>
          </div>
    ...
    <div class="flex flex-1 flex-col md:pl-64">
      <div class="sticky top-0 z-20 bg-gray-800 pl-1 pt-1 text-right sm:pl-3 sm:pt-3 md:hidden">
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center">
            <div
              class="-mt-0.5 inline-flex h-12 w-12 items-center justify-center rounded-md text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
              @click="reloadPage">
              <RefreshIcon
                class="h-6 w-6 text-white"
                aria-hidden="true" />
      ...
      <main class="flex-1">
        <div class="py-6">
          <div class="mx-4 flex max-w-[90%] items-center justify-between sm:mx-auto">
            <h1 class="text-2xl font-semibold capitalize text-gray-900">{{ pageTitle }}</h1>
            <div
              v-if="showButton"
