...
class ThirdPartyInvoice extends Model
{
    ...
    /**
     * Mark invoice as on the house.
     * Both sales and warehouse records are kept because items were consumed
     * and should still appear in item sales reports (promet artikla).
     *
