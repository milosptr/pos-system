;(function () {
  ...
  !(function () {
    ...
    (u = function (t) {
      var i, e
      for (
        t -= 3600 * (i = Math.floor(t / 3600)) + 60 * (e = Math.floor((t - 3600 * i) / 60)), t += '', e += '';
        e.length < 2;
    ...
    (M.prototype.configPercentColors = function () {
      ...
      if (((this.percentColors = null), void 0 !== this.options.percentColors)) {
        for (
          this.percentColors = new Array(), o = [], e = s = 0, n = this.options.percentColors.length - 1;
          0 <= n ? s <= n : n <= s;
          e = 0 <= n ? ++s : --s
        )
      ...
      for (a = e = 0, o = t.length; a < o; a++)
        (l = t[a]) > this.maxValue
          ? this.options.limitMax
            ? (l = this.maxValue)
            : (this.maxValue = l + 1)
          : l < this.minValue && (this.options.limitMin ? (l = this.minValue) : (this.minValue = l - 1)),
          (this.gp[e].value = l),
    ...
    (M.prototype.getAngle = function (t) {
      return (
        ...
        ((t - this.minValue) / (this.maxValue - this.minValue)) * (1 - 2 * this.options.angle) * Math.PI
      )
    }),
    (M.prototype.getColorForPercentage = function (t, i) {
      ...
      if (0 === t) e = this.percentColors[0].color
        ...
        for (
          e = this.percentColors[this.percentColors.length - 1].color, n = o = 0, h = this.percentColors.length - 1;
          0 <= h ? o <= h : h <= o;
          n = 0 <= h ? ++o : --o
        )
      ...
      for (
        ...
        void 0 !== (d = p[a]).label
          ...
          : (!this.options.limitMin || d >= this.minValue) &&
            ...
            this.ctx.rotate(u),
            this.ctx.fillText(g(d, t.fractionDigits), 0, -s - this.lineWidth / 2),
            this.ctx.rotate(-u))
        ...
        void 0 !== this.options.customFillStyle
          ...
          ? ((i =
              0 === this.options.gradientType
                ...
                : this.ctx.createLinearGradient(0, 0, g, 0)).addColorStop(0, this.options.colorStart),
          ...
          this.ctx.translate(g, e)
      for (
        this.options.renderTicks && this.renderTicks(this.options.renderTicks, g, e, l),
          this.ctx.restore(),
          this.ctx.translate(g, e),
          n = 0,
          a = (c = this.gp).length;
      ...
      return (
        ...
        this.value > this.maxValue
          ...
          : this.value < this.minValue &&
            (this.options.limitMin ? (this.value = this.minValue) : (this.minValue = this.value)),
        AnimationUpdater.add(this),
        AnimationUpdater.run(this.forceUpdate),
        (this.forceUpdate = !1)
      )
